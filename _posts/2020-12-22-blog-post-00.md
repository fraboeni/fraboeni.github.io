...
<figure style="width:40%;">
    ...
    <figcaption>Restored training data class representations through model inversion after the model was trained for one epoch.</figcaption>
</figure>
<figure style="width:40%;">
    ...
    <figcaption>Restored training data class representations through model inversion after the model was trained for ten epochs.</figcaption>
</figure>
<figure style="width:40%;">
    ...
    <figcaption>Restored training data class representations through model inversion after the model was trained for 100 epochs.</figcaption>
</figure>
...
\[2\] Nicolae, Maria-Irina, Mathieu Sinn, Minh Ngoc Tran, Beat Buesser, Ambrish Rawat, Martin Wistuba, Valentina Zantedeschi et al. "Adversarial Robustness Toolbox v1. 0.0." arXiv preprint arXiv:1807.01069 [Add to Citavi project by ArXiv ID] (2018).
