...
I decided to use the MNIST dataset which consists of 60.000 training and 10.000 black and white images of the digits from 0 to 9 with the corresponding labels, such as:
...
Once the model is stored, we can start attacking it.
```python
